...
def generate(count, difficulty='medium', language='en', split="train"):
    ...
    for i in tqdm(range(count)):
        ...
        yield {
            "prompt": prompt,
            "answer":  grid,
            "task_name": "skyscraper",    
            "ability": "logic_puzzle", 
            "language": language,
            "meta": json.dumps({
                "id":"skyscraper_"+difficulty+str(i),
                "grid": grid,
                "grid_size":n_size,
                "question": clues,
                "answer": grid,
...
#save_to_jsonl('../skyscraper_en.jsonl', 31500, 'en')
#save_to_jsonl('../skyscraper_zh.jsonl', 31500, 'zh')
