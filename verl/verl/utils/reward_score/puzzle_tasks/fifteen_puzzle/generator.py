...
def generate(count=100, difficulty='medium', language='en', split="train"):
    ...
    for i in tqdm(range(count)):
        ...
        yield {
            ...
            "answer":  board,
            "task_name": "fifteen_puzzle",    
            "ability": "logic_puzzle", 
            "language": language,
            "meta": json.dumps({
                "id":"15-puzzle_"+difficulty+str(i),
                "question": board,
                "answer": board,
                "inversion": inv,
                "rationale": "", 
...
#save_to_jsonl('training/15puzzle/en/train.jsonl', 'raw/15puzzle/en/train.jsonl', 24000, 'en')
#save_to_jsonl('training/15puzzle/zh/train.jsonl', 'raw/15puzzle/zh/train.jsonl',24000, 'zh')

#save_to_jsonl('eval/15puzzle/en/test.jsonl', 'raw/15puzzle/en/test.jsonl', 1500, 'en')
#save_to_jsonl('eval/15puzzle/zh/test.jsonl', 'raw/15puzzle/zh/test.jsonl',1500, 'zh')
