...
#SBATCH -n 96
#SBATCH --mem=256G
#SBATCH --output=/scratch/pioneer/jobs/user/verl/log/my_test/mix-reward/qwen_rope_%A_%a.txt
#SBATCH --error=/scratch/pioneer/jobs/user/verl/log/my_test/mix-reward/qwen_rope_%A_%a.txt
...
nohup python3 -m verl.trainer.main_ppo \
    ...
    > /scratch/pioneer/jobs/user/verl/log/my_test/mix-reward/${exp_name}.log 2>&1
