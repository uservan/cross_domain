...
#SBATCH -n 96
#SBATCH --mem=256G
#SBATCH --output=/scratch/pioneer/jobs/wxy320/verl/log/my_test/mix-reward/qwen_rope_%A_%a.txt
#SBATCH --error=/scratch/pioneer/jobs/wxy320/verl/log/my_test/mix-reward/qwen_rope_%A_%a.txt
...
# set the paths
train_files="['$logic_train_path']" #'$science_train_path' '$code_train_path'  ,'$math_train_path', ,, '$puzzle_train_path'  ,'
test_files="['$math_test_path','$code_test_path','$aime24_test_path','$science_test_path', '$logic_test_path']" #  , '$puzzle_test_path' , '$aime25_test_path',   

# Paths and namings
total_epochs=5
project_name='MIX-REWARD-GRPO'
MODEL_PATH=Qwen/Qwen3-8B-Base # # Qwen/Qwen3-8B
SFT_MODEL=$(basename $MODEL_PATH)
exp_name="${loss_mode}-${SFT_MODEL}-logic"
...
nohup python3 -m verl.trainer.main_ppo \
    ...
    > /scratch/pioneer/jobs/wxy320/verl/log/my_test/mix-reward/${exp_name}.log 2>&1
