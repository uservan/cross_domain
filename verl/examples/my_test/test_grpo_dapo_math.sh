...
ppo_mini_batch_size=4 # 256 # maintain 4 mini-batches as recommended by the paper, see Sec. 5.1
ppo_micro_batch_size_per_gpu=2 # 16 # setup depending on your GPU memory
n_resp_per_prompt=8
...
# Paths and namings
project_name='RL-GRPO'
MODEL_PATH=Qwen/Qwen3-1.7B
SFT_MODEL=$(basename $MODEL_PATH)
exp_name="test-${loss_mode}-${SFT_MODEL}-RL"
...
# set the paths
train_files="['$dapo_math_train_test_path']"
test_files="['$aime24_test_path', '$aime25_test_path',  '$math_test_path', '$olympiadbench_test_path']"
