...
math_train_path=data/train/skywork-Math-5k.parquet # data/train2/skywork-Math-5k.parquet
...
# set the paths
train_files="['$math_train_path']" #'$science_train_path' '$code_train_path'  ,math_train_path, ,, '$puzzle_train_path'  ,' '$logic_train_path'
test_files="['$math_test_path']" # math_test_path,'$aime24_test_path' ,'$science_test_path', '$logic_test_path' '$code_test_path',, '$puzzle_test_path' , '$aime25_test_path',   

# Paths and namings
tag='' # reason, begin, less think, no_think
total_epochs=6
project_name='Tag-GRPO2'
