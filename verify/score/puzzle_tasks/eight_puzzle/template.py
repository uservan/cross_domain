PROMPT_TEMPLATE = """The 8 Puzzle is a classic sliding puzzle game. It consists of a 3×3 grid containing 8 numbered tiles from 1 to 8 and one blank space (represented by 0). The player moves these tiles with the ultimate goal of arranging them in order from 1 to 8. Below are the detailed rules:
