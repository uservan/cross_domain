...
# Generate a random 9-puzzle board
...
def generate(count=100, difficulty='medium', language='en', split="train"):
    ...
    for i in tqdm(range(count)):
        ...
        yield {
            ...
            "answer":  board,
            "task_name": "nine_puzzle",    
            "ability": "logic_puzzle", 
            "language": language,
            "meta": {
                "id":"9-puzzle_"+difficulty+str(i),
                "question": board,
                "answer": board,
                "inversion": inv,
                "rationale": "", 
...
#save_to_jsonl('train.jsonl', 'r_train.jsonl', 10, 'en')
#save_to_jsonl('training/9puzzle/zh/train.jsonl', 'raw/9puzzle/zh/train.jsonl',24000, 'zh')

#save_to_jsonl('eval/9puzzle/en/test.jsonl', 'raw/9puzzle/en/test.jsonl', 1500, 'en')
#save_to_jsonl('eval/9puzzle/zh/test.jsonl', 'raw/9puzzle/zh/test.jsonl',1500, 'zh')